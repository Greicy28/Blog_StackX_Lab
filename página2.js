document.addEventListener("DOMContentLoaded", function () {
  ...
  if (idsvg1 === "olho") {
    ...
    idsegurança.innerHTML =
      " <strong>Importância da Segurança da Informação</strong><br><br>" +
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (idsvg1 === "menu1") {
    ...
    document.querySelector(".views2").style.display = "none";
    document.querySelector(".views3").style.display = "none";
    document.querySelector(".views4").style.display = "none";
    document.querySelector(".visualização1").style.display = "none";
    document.querySelector(".visualização2").style.display = "none";
    document.querySelector(".visualização3").style.display = "none";
    document.querySelector(".visualização4").style.display = "none";
