...
let d=new Date().toLocaleString('pt-br',{day:'2-digit',month:'2-digit',year:"numeric"});
    ...
    document.addEventListener('DOMContentLoaded',function contagem(){
        ...
        olho.addEventListener('click',function contar(){
           ...
           localStorage.setItem('svgClicado', 'olho');
            window.location.replace('http://127.0.0.1:5501/página2.html');
...
olho2.addEventListener('click',function contar2(){
    ...
    window.location.replace('http://127.0.0.1:5501/p%C3%A1gina2.html');
})
});
